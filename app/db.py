...
socketio = SocketIO(app, async_mode="gevent", engineio_logger=True, cors_allowed_origins=['https://amplet.fr', 'http://amplet.fr', 'http://127.0.0.1:5000']) # Uses SocketIO as WS
